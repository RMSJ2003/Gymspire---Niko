...
const userId = '5c8a1d5b0190b214360dc059';
const friendId = '5c8a1d5b0190b214360dc060';
...
socket.on('connect', () => {
    ...
    socket.emit('private-message', { senderId: userId, receiverId: friendId, text: 'Hello User A!' });
